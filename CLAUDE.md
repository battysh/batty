...
- Worktree root: /Users/zedmor/batty/.omx/team/you-are-an-engineer-on-the-bat/worktrees/worker-2
- Team state root: /Users/zedmor/batty/.omx/state
- Inbox path: /Users/zedmor/batty/.omx/state/team/you-are-an-engineer-on-the-bat/workers/worker-2/inbox.md
- Mailbox path: /Users/zedmor/batty/.omx/state/team/you-are-an-engineer-on-the-bat/mailbox/worker-2.json
...
- Worker status path: /Users/zedmor/batty/.omx/state/team/you-are-an-engineer-on-the-bat/workers/worker-2/status.json
- Worker identity path: /Users/zedmor/batty/.omx/state/team/you-are-an-engineer-on-the-bat/workers/worker-2/identity.json

## Protocol
1. Read your inbox at `/Users/zedmor/batty/.omx/state/team/you-are-an-engineer-on-the-bat/workers/worker-2/inbox.md`.
...
3. Send startup ACK before task work:
   ...
   `omx team api send-message --input "{"team_name":"you-are-an-engineer-on-the-bat","from_worker":"worker-2","to_worker":"leader-fixed","body":"ACK: worker-2 initialized"}" --json`
...
7. Use mailbox delivery flow:
   - `omx team api mailbox-list --input "{"team_name":"you-are-an-engineer-on-the-bat","worker":"worker-2"}" --json`
   - `omx team api mailbox-mark-delivered --input "{"team_name":"you-are-an-engineer-on-the-bat","worker":"worker-2","message_id":"<MESSAGE_ID>"}" --json`
